 ...
 *
 */
public class InitializerMsgListener
     ...
     * @param client
     */
    public InitializerMsgListener(final CommonMsgListener genericListener) {
        super();
    ...
    public void onMessage(ClientSessionChannel channel, Message message) {
        this.genericListener.onInitialize(message.isSuccessful());
    }
