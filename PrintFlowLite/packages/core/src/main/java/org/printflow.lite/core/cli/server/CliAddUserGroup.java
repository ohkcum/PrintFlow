 ...
 *
 */
public class CliAddUserGroup extends AbstractAppApi {
    ...
    private static final String METHOD_SHORT_DESCRIPT =
            "Adds a user group from the external user source: "
                    + "synchronized external users belonging "
    ...
    protected final String getMethodName() {
        return JsonRpcMethodName.ADD_USER_GROUP.getMethodName();
    }
