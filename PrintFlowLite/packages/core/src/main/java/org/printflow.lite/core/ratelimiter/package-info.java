...
/**
 * A simple <a href="https://en.wikipedia.org/wiki/Rate_limiting">Rate
 * Limiting</a> implementation.
 * <a href="https://en.wikipedia.org/wiki/Token_bucket">Token Bucket</a>
 * algorithm, courtesy of
 * <a href="https://github.com/hn3000/rate-limiter-java">this project</a>.
 *
 * @author Rijk Ravestein
 */
