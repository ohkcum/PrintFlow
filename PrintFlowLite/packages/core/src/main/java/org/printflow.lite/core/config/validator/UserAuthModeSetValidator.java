 ...
 *
 */
public final class UserAuthModeSetValidator extends AbstractSetValidator {

    /**
     * @param optional
     *            {@code true} if value is optional.
     */
    public UserAuthModeSetValidator(final boolean optional) {
        super(optional);
    }

    @Override
    protected boolean onItem(final String item) {
        return UserAuthModeEnum.fromDbValue(item) != null;
    }
