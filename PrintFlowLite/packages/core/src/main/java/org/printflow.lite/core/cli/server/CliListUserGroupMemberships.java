 ...
 *
 */
public class CliListUserGroupMemberships extends AbstractAppApi {
    ...
    private static final String METHOD_SHORT_DESCRIPT =
            "Lists the names of the groups a user belongs to, "
    ...
    */
    ...
    protected final String getMethodName() {
        return JsonRpcMethodName.LIST_USER_GROUP_MEMBERSHIPS.getMethodName();
    }
    ...
    protected final AbstractJsonRpcMethodParms createMethodParms(
        ...
        final ParamsSingleFilterList parms = new ParamsSingleFilterList();

        parms.setFilter(cmd.getOptionValue(CLI_OPT_USERNAME));
