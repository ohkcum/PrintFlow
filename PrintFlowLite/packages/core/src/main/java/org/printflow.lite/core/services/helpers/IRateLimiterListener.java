...
public interface IRateLimiterListener {
    ...
    /**
     * Notification of a rate limited event before waiting time is applied.
     *
     * @param event
     *            {@link IEvent}.
     * @param waitMsec
     *            Waiting time (msecs) that is applied after this notification
     *            method is send.
     */
    void onRateLimited(IEvent event, long waitMsec);
