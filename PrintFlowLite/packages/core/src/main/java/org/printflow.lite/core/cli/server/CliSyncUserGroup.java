 ...
 *
 */
public class CliSyncUserGroup extends AbstractAppApi {
    ...
    private static final String METHOD_SHORT_DESCRIPT =
            "Synchronizes a user group with "
                    + "the external user source, updating group membership.";
    ...
    { ARG_TEXT + "(255)", CLI_OPT_GROUPNAME,
            "The name of the group to synchronize.", Boolean.TRUE }
    //
            };
    ...
    protected final String getMethodName() {
        return JsonRpcMethodName.SYNC_USER_GROUP.getMethodName();
    }
