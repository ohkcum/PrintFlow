...
public class AccountTrxPagerReq extends AbstractPagerReq {
     ...
     *
     * @return {@link AccountTrxPagerReq.Select}.
     */
    public Select createSelect() {
        this.select = new AccountTrxPagerReq.Select();
        return this.select;
    }
     ...
     *
     * @return {@link AccountTrxPagerReq.Sort}.
     */
    public Sort createSort() {
        this.sort = new AccountTrxPagerReq.Sort();
        return this.sort;
    }
}
