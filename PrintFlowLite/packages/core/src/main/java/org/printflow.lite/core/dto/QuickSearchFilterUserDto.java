 ...
 *
 */
public class QuickSearchFilterUserDto extends QuickSearchFilterDto {
    ...
    public Boolean getExcludeRequester() {
        return excludeRequester;
    }

    public void setExcludeRequester(Boolean excludeRequester) {
