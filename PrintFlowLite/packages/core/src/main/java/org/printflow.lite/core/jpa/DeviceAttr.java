 ...
 */
@Entity
@Table(name = DeviceAttr.TABLE_NAME)
public class DeviceAttr extends org.printflow.lite.core.jpa.Entity {
    ...
    @TableGenerator(name = "deviceAttrPropGen", table = Sequence.TABLE_NAME,
            //
