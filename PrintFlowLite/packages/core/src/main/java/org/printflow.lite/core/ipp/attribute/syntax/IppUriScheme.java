...
public final class IppUriScheme extends AbstractIppAttrSyntax {
    ...
    /** */
    public static final String SCHEME_HTTP = InetUtils.URL_PROTOCOL_HTTP;
    /** */
    public static final String SCHEME_HTTPS = InetUtils.URL_PROTOCOL_HTTPS;
    /** */
    public static final String SCHEME_IPP = InetUtils.URL_PROTOCOL_IPP;
    /** */
    public static final String SCHEME_IPPS = InetUtils.URL_PROTOCOL_IPPS;
    /** */
    public static final String SCHEME_LPD = "lpd";
    /** */
    public static final String SCHEME_SERIAL = "serial";
    /** */
