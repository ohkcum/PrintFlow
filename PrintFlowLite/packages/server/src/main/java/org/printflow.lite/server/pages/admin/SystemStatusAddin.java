 ...
 *
 */
public final class SystemStatusAddin extends AbstractAdminPage {
     ...
     *            The page parameters.
     */
    public SystemStatusAddin(final PageParameters parameters) {
        ...
        systemStatusPanel
                .populate(this.probePermissionToEdit(ACLOidEnum.A_DASHBOARD));
