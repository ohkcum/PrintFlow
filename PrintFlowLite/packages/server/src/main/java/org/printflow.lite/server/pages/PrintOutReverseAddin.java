 ...
 *
 */
public final class PrintOutReverseAddin extends AbstractAuthPage {
     ...
     */
    public PrintOutReverseAddin(final PageParameters parameters) {
        super(parameters);
        ...
        helper.addModifyLabelAttr("btn-yes",
                ...
                MarkupHelper.ATTR_DATA_PrintFlowLite, docLog.getId().toString());
    }
