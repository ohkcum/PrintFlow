...
import org.printflow.lite.server.session.JobTicketSession;
    ...
    protected void onRequest(final String requestingUser, final User lockedUser)
        ...
        try {
            ...
            if (dtoReq.isPrint()) {
                ...
                /*
                 * INVARIANT: When org.printflow.lite-job-sheet is specified,
            ...
            this.setApiResult(ApiResultCodeEnum.UNAVAILABLE,
