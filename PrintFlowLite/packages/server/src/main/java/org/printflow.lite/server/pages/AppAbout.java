...
public final class AppAbout extends AbstractPage {
    ...
    public AppAbout(final PageParameters parameters) {
        ...
        final String appName =
                CommunityDictEnum.PrintFlowLite.getWord(Locale.getDefault());
        ...
        if (inject.isInjectAvailable()) {
            ...
            add(new AppAboutPanel("PrintFlowLite-info-after-inject", webAppType));
            ...
            helper.discloseLabel("PrintFlowLite-info-after-inject");
            helper.encloseLabel("app-version",
                    ConfigManager.getAppNameVersion(), true);
            add(new Label("app-slogan",
                    CommunityDictEnum.PRINTFLOWLITE_SLOGAN.getWord()));
            add(new AppAboutPanel("PrintFlowLite-info", webAppType));
        }
