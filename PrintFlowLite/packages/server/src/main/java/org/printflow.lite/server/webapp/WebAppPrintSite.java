...
public final class WebAppPrintSite extends AbstractWebAppPage {
    ...
    protected void appendWebAppTypeJsFiles(
        ...
        list.add(
                new ImmutablePair<>(
                        String.format("%s%s",
                                "jquery.PrintFlowLite-printsite-panels.js", nocache),
                        PrintFlowLite_JS_LICENSE));

        list.add(
                new ImmutablePair<>(
                        String.format("%s%s",
                                "jquery.PrintFlowLite-printsite-pages.js", nocache),
                        PrintFlowLite_JS_LICENSE));
    ...
    protected String getSpecializedCssFileName() {
        return "jquery.PrintFlowLite-printsite.css";
    }

    @Override
    protected String getSpecializedJsFileName() {
        return "jquery.PrintFlowLite-printsite.js";
    }
