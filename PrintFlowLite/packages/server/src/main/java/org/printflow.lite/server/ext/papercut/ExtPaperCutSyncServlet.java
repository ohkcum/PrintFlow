...
public final class ExtPaperCutSyncServlet extends BasicAuthServlet {
    ...
    /** */
    private static final String RPFL_OK = "OK";

    /** */
    private static final String RPFL_ERROR = "ERROR";

    /** */
    private static final String RPFL_YES = "Y";

    /** */
    private static final String RPFL_NO = "N";
    ...
    private static void onUserAuth(final String username, final String password,
        ...
        if (ConfigManager.instance().getUserAuthenticator()
            ...
            ostr.write(RPFL_OK.getBytes());
        } else {
            ostr.write(RPFL_ERROR.getBytes());
        }
        ostr.write('\n');
    }
