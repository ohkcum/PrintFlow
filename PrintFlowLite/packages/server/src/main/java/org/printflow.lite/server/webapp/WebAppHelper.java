...
public final class WebAppHelper {
    ...
    private static void debugProxyXFF(final String xffHeader,
        ...
        AdminPublisher.instance().publish(PubTopicEnum.USER, PubLevelEnum.INFO,
                String.format("[DEBUG] HTTP %s [%s]: %s",
                        ...
                        Objects.toString(xffHeader, " "), msg));
    }
    ...
    /**
     * Sets the duration for which a resource will be cached by the browser to
     * zero.
     *
     * @param handler
     ...
     */
    public static void
            setCacheDurationZero(final ResourceStreamRequestHandler handler) {
