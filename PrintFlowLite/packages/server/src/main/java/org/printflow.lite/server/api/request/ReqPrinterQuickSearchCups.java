...
/**
 * Quick Search of all Proxy Printers as synchronized with CUPS.
 *
 * @author Rijk Ravestein
 *
 */
public final class ReqPrinterQuickSearchCups
        extends ReqPrinterQuickSearchMixin {

    @Override
    protected JsonPrinterList getPrinterList(final String requestingUser) {
        // requestingUser is irrelevant.
        try {
            return PROXY_PRINT_SERVICE.getSimplePrinterList();
