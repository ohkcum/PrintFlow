...
public final class PrinterSnmpPanel extends Panel {
    ...
    public PrinterSnmpPanel(final String id, final Long printerID,
        ...
        if (printerID == null) {
            ...
            MarkupHelper.modifyComponentAttr(btnRefresh,
                    MarkupHelper.ATTR_DATA_PrintFlowLite, printerID.toString());
        }
        //
        final boolean hasInfo = info != null && info.getDate() != null;

        final String vendor;

        if (hasInfo && extended && info.getVendor() != null) {
        ...
        helper.encloseLabel(WID_VENDOR, vendor,
                hasInfo && extended && info.getVendor() != null);
        ...
        if (hasInfo) {
            ...
            helper.encloseLabel(WID_MODEL, info.getModel(),
                    hasInfo && extended && info.getModel() != null);
            helper.encloseLabel(WID_SERIAL, info.getSerial(),
                    hasInfo && extended && info.getSerial() != null);

            final boolean hasMarkers =
                    info.getMarkers() != null && !info.getMarkers().isEmpty();
            ...
            if (duration == 0) {
                ...
                if (info.getErrorStates() != null) {
                    ...
                    states.append(AdjectiveEnum.UNKNOWN.uiText(getLocale()));
                }
