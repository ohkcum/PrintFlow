...
import org.printflow.lite.core.print.proxy.ProxyPrintJobStatusCups;
 ...
 *
 */
public final class CupsEventHandler
        implements IXmlRpcHandler, ServiceEntryPoint {
    ...
    /**
     * Notification from custom PrintFlowLite CUPS notifier.
     * <p>
     ...
     * use case of restored backup on a new PrintFlowLite server with a different
     * job_id counter.
     * </p>
     *
     * @param apiId
    ...
    public Map<String, Object> printerEvent(final String apiId,
            final String apiKey, final String event, final String printerName,
            final Integer printerState) {
        ...
        try {
            ...
            PROXY_PRINT_SERVICE.notificationRecipient().onPrinterEvent(
                    printerName, IppPrinterEventEnum.asEnum(event),
                    IppPrinterStateEnum.asEnum(printerState.intValue()));
    ...
    public Map<String, Object> serverEvent(final String apiId,
        ...
        try {
            ...
            PROXY_PRINT_SERVICE.notificationRecipient()
                    .onServerEvent(IppServerEventEnum.asEnum(event));
