...
import org.printflow.lite.ext.print.IppRoutingDto;
import org.printflow.lite.ext.print.QrCodeAnchorEnum;
import org.printflow.lite.server.restful.RestApplication;
import org.printflow.lite.server.restful.RestAuthFilter;
import org.printflow.lite.server.restful.dto.RestHttpRequestDto;
...
public final class RestTestService extends AbstractRestService {
    ...
    public static void test() {
        ...
        final String serverHost = InetUtils.LOCAL_HOST;

        final WebTarget webTarget = client
                .target(InetUtils.URL_PROTOCOL_HTTPS + "://" + serverHost + ":"
