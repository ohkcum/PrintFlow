...
public final class QueuesPage extends AbstractAdminListPage {
    ...
    private final class QueueListView extends PropertyListView<IppQueue> {
        ...
        /** */
        private static final String WID_IMG_BASIC_AUTH = "img-basic-auth";
         ...
         *            Title.
         */
        private void addImage(final MarkupHelper helper, final boolean enabled,
                final String pathPng, final String png, final String widImg,
        ...
        protected void populateItem(final ListItem<IppQueue> item) {
            ...
            this.addImage(helper,
                    this.isJournalEnabled
                            && !QUEUE_SERVICE.isDocStoreJournalDisabled(queue),
                    WebApp.PATH_IMAGES, "journal-16x16.png", WID_IMG_JOURNAL,
                    NounEnum.JOURNAL);

            this.addImage(helper,
                    QUEUE_SERVICE.getIppAuthMethod(queue).isClientChallenged(),
                    WebApp.PATH_IMAGES_FAMFAM, "user_gray.png",
                    WID_IMG_BASIC_AUTH, NounEnum.AUTHENTICATION);
            ...
            /*
             * Set the primary key in 'data-PrintFlowLite' attribute, so it can be
