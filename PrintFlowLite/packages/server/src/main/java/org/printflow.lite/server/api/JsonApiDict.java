...
import org.printflow.lite.server.api.request.ReqAtomFeedRefresh;
import org.printflow.lite.server.api.request.ReqConfigPropGet;
import org.printflow.lite.server.api.request.ReqConfigPropsSet;
import org.printflow.lite.server.api.request.ReqDbBackup;
import org.printflow.lite.server.api.request.ReqDeviceDelete;
import org.printflow.lite.server.api.request.ReqDeviceGet;
import org.printflow.lite.server.api.request.ReqDeviceSet;
import org.printflow.lite.server.api.request.ReqDocLogRefund;
import org.printflow.lite.server.api.request.ReqDocLogStoreDelete;
import org.printflow.lite.server.api.request.ReqDocLogTicketReopen;
import org.printflow.lite.server.api.request.ReqGenerateUserIDNumber;
import org.printflow.lite.server.api.request.ReqGenerateUuid;
import org.printflow.lite.server.api.request.ReqI18nCacheClear;
import org.printflow.lite.server.api.request.ReqInboxClear;
import org.printflow.lite.server.api.request.ReqInboxRestorePrintIn;
import org.printflow.lite.server.api.request.ReqJobTicketCancel;
import org.printflow.lite.server.api.request.ReqJobTicketExec;
import org.printflow.lite.server.api.request.ReqJobTicketPrintCancel;
import org.printflow.lite.server.api.request.ReqJobTicketPrintClose;
import org.printflow.lite.server.api.request.ReqJobTicketQuickSearch;
import org.printflow.lite.server.api.request.ReqJobTicketSaveCopies;
import org.printflow.lite.server.api.request.ReqJobTicketSaveOptions;
import org.printflow.lite.server.api.request.ReqLogin;
import org.printflow.lite.server.api.request.ReqLogout;
import org.printflow.lite.server.api.request.ReqMailTest;
import org.printflow.lite.server.api.request.ReqMailTicketQuickSearch;
import org.printflow.lite.server.api.request.ReqOAuthUrl;
import org.printflow.lite.server.api.request.ReqOutboxCancelAll;
import org.printflow.lite.server.api.request.ReqOutboxCancelJob;
import org.printflow.lite.server.api.request.ReqOutboxExtend;
import org.printflow.lite.server.api.request.ReqOutboxReleaseJob;
import org.printflow.lite.server.api.request.ReqPageOverlayGet;
import org.printflow.lite.server.api.request.ReqPageOverlaySet;
import org.printflow.lite.server.api.request.ReqPdfPropsSetValidate;
import org.printflow.lite.server.api.request.ReqPosDepositQuickSearch;
import org.printflow.lite.server.api.request.ReqPosSales;
import org.printflow.lite.server.api.request.ReqPrintOutJobStateSet;
import org.printflow.lite.server.api.request.ReqPrintSiteUserSet;
import org.printflow.lite.server.api.request.ReqPrinterGet;
import org.printflow.lite.server.api.request.ReqPrinterGroupQuickSearch;
import org.printflow.lite.server.api.request.ReqPrinterOptValidate;
import org.printflow.lite.server.api.request.ReqPrinterPrint;
import org.printflow.lite.server.api.request.ReqPrinterQuickSearchCups;
import org.printflow.lite.server.api.request.ReqPrinterQuickSearchUser;
import org.printflow.lite.server.api.request.ReqPrinterSet;
import org.printflow.lite.server.api.request.ReqPrinterSetMediaSources;
import org.printflow.lite.server.api.request.ReqPrinterSnmp;
import org.printflow.lite.server.api.request.ReqPrinterSync;
import org.printflow.lite.server.api.request.ReqQueueEnable;
import org.printflow.lite.server.api.request.ReqQueueGet;
import org.printflow.lite.server.api.request.ReqQueueSet;
import org.printflow.lite.server.api.request.ReqSharedAccountGet;
import org.printflow.lite.server.api.request.ReqSharedAccountQuickSearch;
import org.printflow.lite.server.api.request.ReqSharedAccountSet;
import org.printflow.lite.server.api.request.ReqSystemModeChange;
import org.printflow.lite.server.api.request.ReqUrlPrint;
import org.printflow.lite.server.api.request.ReqUserCardQuickSearch;
import org.printflow.lite.server.api.request.ReqUserDelegateAccountsPreferred;
import org.printflow.lite.server.api.request.ReqUserDelegateGroupsPreferred;
import org.printflow.lite.server.api.request.ReqUserGet;
import org.printflow.lite.server.api.request.ReqUserGetDelegateAccountsPreferredSelect;
import org.printflow.lite.server.api.request.ReqUserGetDelegateGroupsPreferredSelect;
import org.printflow.lite.server.api.request.ReqUserGroupGet;
import org.printflow.lite.server.api.request.ReqUserGroupMemberQuickSearch;
import org.printflow.lite.server.api.request.ReqUserGroupQuickSearch;
import org.printflow.lite.server.api.request.ReqUserGroupSet;
import org.printflow.lite.server.api.request.ReqUserGroupsAddRemove;
import org.printflow.lite.server.api.request.ReqUserHomeClean;
import org.printflow.lite.server.api.request.ReqUserInitInternal;
import org.printflow.lite.server.api.request.ReqUserNameAliasesRefresh;
import org.printflow.lite.server.api.request.ReqUserNotifyAccountChange;
import org.printflow.lite.server.api.request.ReqUserPasswordErase;
import org.printflow.lite.server.api.request.ReqUserPinErase;
import org.printflow.lite.server.api.request.ReqUserQuickSearch;
import org.printflow.lite.server.api.request.ReqUserRegistration;
import org.printflow.lite.server.api.request.ReqUserRegistrationPermit;
import org.printflow.lite.server.api.request.ReqUserSet;
import org.printflow.lite.server.api.request.ReqUserSetDelegateAccountsPreferredSelect;
import org.printflow.lite.server.api.request.ReqUserSetDelegateGroupsPreferredSelect;
import org.printflow.lite.server.api.request.ReqUserSetTelegramID;
import org.printflow.lite.server.api.request.ReqUserTOTPReplace;
import org.printflow.lite.server.api.request.ReqUserTOTPSendRecoveryCode;
import org.printflow.lite.server.api.request.ReqUserTOTPSet;
import org.printflow.lite.server.api.request.ReqUserTOTPTelegramEnable;
import org.printflow.lite.server.api.request.ReqUserTestTelegramID;
import org.printflow.lite.server.api.request.ReqUserUuidReplace;
import org.printflow.lite.server.api.request.ReqVoucherBatchCreate;
import org.printflow.lite.server.api.request.ReqVoucherBatchDelete;
import org.printflow.lite.server.api.request.ReqVoucherBatchExpire;
import org.printflow.lite.server.api.request.ReqVoucherDeleteExpired;
import org.printflow.lite.server.api.request.ReqVoucherRedeem;
...
public final class JsonApiDict {
    ...
    public static final String REQ_PRINTOUT_JOBSTATE_SET =
            "printout-jobstate-set";
    ...
    public static final String REQ_PRINTER_RAWPRINT_PPD_DOWNLOAD =
            "printer-rawprint-ppd-download";
    public static final String REQ_PRINTER_RAWPRINT_TRANSFORM_DOWNLOAD =
            "printer-rawprint-transform-download";
    ...
    public static final String REQ_ERASE_USER_PIN = "erase-user-pin";
    ...
    public static final String REQ_USER_REGISTRATION = "user-registration";
    public static final String REQ_USER_REGISTRATION_PERMIT =
            "user-registration-permit";
    ...
    public static final String REQ_ATOMFEED_REFRESH = "atomfeed-refresh";
    ...
    public static final String REQ_USER_TOTP_SET = "user-totp-set";
    ...
    public static boolean isDownloadRequest(final String request) {
        ...
        case REQ_PRINTER_RAWPRINT_PPD_DOWNLOAD:
        case REQ_PRINTER_RAWPRINT_TRANSFORM_DOWNLOAD:
    ...
    public JsonApiDict() {
        ...
        adm(REQ_ACCOUNT_VOUCHER_BATCH_CREATE, ReqVoucherBatchCreate.class,
                DbClaim.READ, DbAccess.YES);
        adm(REQ_ACCOUNT_VOUCHER_BATCH_DELETE, ReqVoucherBatchDelete.class,
                DbClaim.READ, DbAccess.YES);
        adm(REQ_ACCOUNT_VOUCHER_BATCH_EXPIRE, ReqVoucherBatchExpire.class,
                DbClaim.READ, DbAccess.YES);
        adm(REQ_ACCOUNT_VOUCHER_BATCH_PRINT, DbClaim.READ, DbAccess.YES);

        adm(REQ_ACCOUNT_VOUCHER_DELETE_EXPIRED, ReqVoucherDeleteExpired.class,
                DbClaim.READ, DbAccess.YES);

        usr(REQ_ACCOUNT_VOUCHER_REDEEM, ReqVoucherRedeem.class, DbClaim.READ,
                DbAccess.USER_LOCK);
        ...
        adm(REQ_PRINTOUT_JOBSTATE_SET, ReqPrintOutJobStateSet.class,
                DbClaim.READ, DbAccess.YES);
        ...
        usr(REQ_USER_TOTP_SET, ReqUserTOTPSet.class, DbClaim.READ,
                DbAccess.YES);
        ...
        adm(REQ_PRINTER_RAWPRINT_PPD_DOWNLOAD, DbClaim.NONE, DbAccess.YES);
        adm(REQ_PRINTER_RAWPRINT_TRANSFORM_DOWNLOAD, DbClaim.NONE,
                DbAccess.YES);
        ...
        usr(REQ_ERASE_USER_PIN, ReqUserPinErase.class, DbClaim.READ,
                DbAccess.USER_LOCK);
        ...
        put(REQ_USER_REGISTRATION, ReqUserRegistration.class, AuthReq.NONE,
                DbClaim.READ, DbAccess.YES);
        put(REQ_USER_REGISTRATION_PERMIT, ReqUserRegistrationPermit.class,
                AuthReq.NONE, DbClaim.NONE, DbAccess.NO);
        ...
        adm(REQ_ATOMFEED_REFRESH, ReqAtomFeedRefresh.class, DbClaim.NONE,
                DbAccess.YES);
