...
import org.printflow.lite.server.pages.ExtSupplierStatusPanel;
...
public class OutboxAddin extends AbstractUserPage {
    ...
    private class OutboxJobView extends PropertyListView<OutboxJobDto> {
        ...
        protected void populateItem(final ListItem<OutboxJobDto> item) {
            ...
            if (cachedPrinter == null) {
                ...
                printerDisplayName = Objects.toString(
            ...
            //
            if (job.getPdfLength() != null) {
                totals.append(" &bull; ")
                        .append(NumberUtil.humanReadableByteCountSI(locale,
                                job.getPdfLength().longValue()));
            }
            ...
            if (printOut == null) {
                ...
                final org.printflow.lite.core.jpa.DocLog docLog =
            ...
            if (printOut == null) {
                ...
                final Date dateCreation = IPP_CLIENT_SERVICE
                ...
                if (jobState.isFinished()
                    ...
                    final Date dateCompleted = IPP_CLIENT_SERVICE
            ...
            if (BooleanUtils.isTrue(job.getArchive())) {
                ...
                final org.printflow.lite.core.jpa.User userWlk;
                if (user == null) {
        ...
        private Label addJobIdAttr(final Label label, final OutboxJobDto job) {
            label.add(new AttributeModifier(MarkupHelper.ATTR_DATA_PrintFlowLite,
                    job.getFile()))
    ...
    public OutboxAddin(final PageParameters parameters) {
        ...
        if (isJobticketView) {
            ...
            final org.printflow.lite.core.jpa.User lockedUser =
