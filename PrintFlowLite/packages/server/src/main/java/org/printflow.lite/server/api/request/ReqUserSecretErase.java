 ...
 *
 */
public abstract class ReqUserSecretErase extends ApiRequestMixin {
    ...
    /**
     * @return The secret attribute to erase.
     */
    protected abstract UserAttrEnum getSecret();
    ...
    protected void onRequest(final String requestingUser, final User lockedUser)
        ...
        USER_SERVICE.removeUserAttr(user, this.getSecret());

        setApiResult(ApiResultCodeEnum.OK, "msg-user-secret-erased-ok");
    }
}
