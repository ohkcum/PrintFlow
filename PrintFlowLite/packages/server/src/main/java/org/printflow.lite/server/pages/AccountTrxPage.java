...
public final class AccountTrxPage extends AbstractListPage {
    ...
    private final class AccountTrxListView
         ...
         * @param entryList
         */
        AccountTrxListView(final String id, final List<AccountTrx> entryList) {
        ...
        protected void populateItem(final ListItem<AccountTrx> item) {
            ...
            case PRINT_OUT:
                ...
                if (printMode == PrintModeEnum.TICKET
                    ...
                    jobticket = String.format("%s %s (%s)",
                            ...
                            Objects.toString(docLog.getExternalId(), "???"),
            ...
            helper.encloseLabel("extSupplier", extSupplier, extSupplier != null
                    && extSupplierEnum != ExternalSupplierEnum.PrintFlowLite);
