 ...
 */
package org.printflow.lite.ext.print;
...
public final class IppRoutingPlugin implements ServerPlugin {
    ...
    /** */
    private static final String PROP_KEY_ROUTING_REST_POST_RPFL_MEDIATYPE =
    ...
    private void onInitRoutingREST(final ServerPluginContext ctx,
        ...
        this.routingRestRspMediaType =
                props.getProperty(PROP_KEY_ROUTING_REST_POST_RPFL_MEDIATYPE);
    ...
    private static void onRoutingPdfInfo(final PdfStamper stamper,
        ...
        final Map<String, String> info = stamper.getReader().getInfo();
