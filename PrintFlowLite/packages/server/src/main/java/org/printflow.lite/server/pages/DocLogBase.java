...
public final class DocLogBase extends AbstractAuthPage {
    ...
    /** */
    private static final int MAX_PDF_OUT_PASSWORD_LENGTH = 255;
    ...
    public DocLogBase(final PageParameters parameters) {
        ...
        this.handlePage(webAppType);
    }

    /** */
    private void handlePasswordPanels() {

        this.add(PasswordPanel.createPopulate("sp-pdf-out-pw-user-panel",
                "sp-pdf-out-pw-user", MAX_PDF_OUT_PASSWORD_LENGTH));
        this.add(PasswordPanel.createPopulate("sp-pdf-out-pw-owner-panel",
                "sp-pdf-out-pw-owner", MAX_PDF_OUT_PASSWORD_LENGTH));
    }
    ...
    private void handlePage(final WebAppTypeEnum webAppType) {
        ...
        helper.addLabel("option-job-state-unknown",
                IppJobStateEnum.IPP_JOB_UNKNOWN.uiText(getLocale()));
        /*
         *
         */
