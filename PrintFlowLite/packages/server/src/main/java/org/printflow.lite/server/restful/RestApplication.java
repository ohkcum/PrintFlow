...
import org.printflow.lite.server.restful.services.RestDocumentsService;
import org.printflow.lite.server.restful.services.RestFinancialService;
import org.printflow.lite.server.restful.services.RestReportsService;
...
public final class RestApplication extends ResourceConfig {
    ...
    private static final Class<?>[] SERVICES_REGISTRY = new Class<?>[] { //
            ...
            RestReportsService.class, //
            RestFinancialService.class, //
    ...
    public RestApplication() {
        ...
        this.packages(org.printflow.lite.server.restful.services.IRestService.class
                .getPackage().getName());
