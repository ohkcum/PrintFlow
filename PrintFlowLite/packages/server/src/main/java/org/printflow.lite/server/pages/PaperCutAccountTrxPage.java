...
import org.printflow.lite.ext.papercut.PaperCutAccountTrxPagerReq;
import org.printflow.lite.ext.papercut.PaperCutAccountTrxTypeEnum;
...
public final class PaperCutAccountTrxPage extends AbstractListPage {
    ...
    private final class AccountTrxListView
        ...
        protected void populateItem(final ListItem<PaperCutAccountTrx> item) {
            ...
            if (trxType == null) {
                trxTypeUI = Objects.toString(trx.getTransactionType(), "\"?\"");
