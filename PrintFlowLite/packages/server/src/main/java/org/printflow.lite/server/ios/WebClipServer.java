 ...
 */
package org.printflow.lite.server.ios;
...
public class WebClipServer extends WebPage {
    ...
    public WebClipServer(final PageParameters parameters) {
        ...
        final String basePayloadIdentifier = "org.printflow.lite.webapp";
        ...
        String desc =
                localize("webclip-motto", CommunityDictEnum.PrintFlowLite.getWord());

        // String desc =
        // "Druk op \"Installeren\", en start de PrintFlowLite app vanaf uw
         ...
         * this icon, fullscreen PrintFlowLite gets the focus again, but goes back to
