 ...
 *
 */
public final class ReqExportPrinterRawTransform
        extends AbstractReqExportPrinterFile {
     ...
     */
    public ReqExportPrinterRawTransform(final Long id) {
        super(id);
    }

    @Override
    protected PrinterAttrEnum getPrinterAttrEnum() {
        return PrinterAttrEnum.RAW_PRINT_TRANSFORM_FILE;
    }
