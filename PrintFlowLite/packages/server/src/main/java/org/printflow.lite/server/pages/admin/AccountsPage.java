...
import org.printflow.lite.core.dao.helpers.AccountPagerReq;
...
public final class AccountsPage extends AbstractAdminListPage {
    ...
    private final class AccountListView extends PropertyListView<Account> {
        ...
        /** */
        private static final String WID_BALANCE_PrintFlowLite_ICON =
                "balance-PrintFlowLite-icon";
        ...
        protected void populateItem(final ListItem<Account> item) {
            ...
            try {
                ...
                if (this.hasPaperCutUserAccountView) {
                    helper.addTransparant(WID_BALANCE_PrintFlowLite_ICON)
                    ...
                    helper.discloseLabel(WID_BALANCE_PrintFlowLite_ICON);
                }
