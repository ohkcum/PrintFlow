...
import org.printflow.lite.core.dto.JobTicketLabelDomainPartDto;
...
import org.printflow.lite.server.pages.PageIllegalState;
import org.printflow.lite.server.pages.QuickSearchPanel;
...
public class Print extends AbstractUserPage {
    ...
    public Print(final PageParameters parameters) {
        ...
        boolean isProxyPrintConfirm =
                isMailPrintTicketOperator || (webAppType == WebAppTypeEnum.USER
                        && ConfigManager.instance().isConfigValue(
                                Key.WEBAPP_USER_PROXY_PRINT_CONFIRM));
        ...
        helper.encloseLabel(ID_BTN_PRINT_AND_CLOSE,
                this.localized("button-print-and-close"), !isProxyPrintConfirm);

        helper.addLabel("sp-popup-print-and-close-title", NounEnum.COST);
        helper.addLabel("print-and-close-popup-wait-msg",
                PhraseEnum.PLEASE_WAIT);
        ...
        helper.addLabel("proxy-print-wait-msg", PhraseEnum.PLEASE_WAIT);
        ...
        helper.encloseLabel("prompt-collate",
                PrintOutVerbEnum.COLLATE.uiText(getLocale()),
                cm.isConfigValue(Key.WEBAPP_USER_PROXY_PRINT_COLLATE_SHOW));
