 ...
 *
 */
public final class PDLTransformFileOptionsAddin extends AbstractAdminPage
     ...
     *            The page parameters.
     */
    public PDLTransformFileOptionsAddin(final PageParameters parameters) {

        super(parameters);

        final FileOptionsPanel panel = new FileOptionsPanel("panel",
                ConfigManager.getServerCustomRawPrintTransformsHome(),
                FileNameExtEnum.JSON);
        add(panel);
        panel.populate();
    }
