 ...
 * </p>
 * <p>
 * INVARIANT: CSS_* constants MUST match CSS classes in jquery.PrintFlowLite.css
 * </p>
 *
...
public final class MarkupHelper {
    ...
    public static final String ATTR_AUTOCORRECT = "autocorrect";
    ...
    public static final String ATTR_STYLE_DISPLAY_NONE = "display: none;";
    public static final String ATTR_STYLE_RIGHT_TEXT_ALIGN_OPACITY_HALF =
            "text-align: right;opacity: 0.5;";

    public static final String ATTR_AUTOCOMPLETE_ONE_TIME_CODE =
            "one-time-code";
    public static final String ATTR_AUTOCOMPLETE_OFF = "off";
    ...
    public static final String ATTR_DATA_PrintFlowLite = "data-PrintFlowLite";
    public static final String ATTR_DATA_PrintFlowLite_KEY = "data-PrintFlowLite-key";
    public static final String ATTR_DATA_PrintFlowLite_TYPE = "data-PrintFlowLite-type";
    ...
    public static final String CSS_UI_MINI = "ui-mini";
    ...
    /**
     * Image path for User OpenPGP Public Key for sending mail.
     */
    public static final String IMG_PATH_USER_MAIL_OPENPGP =
            WebApp.PATH_IMAGES_FAMFAM + "/key.png";

    /**
     * Image path for unknown Account.
     */
    ...
    /**
     * Image path for pending user registrations.
     */
    public static final String IMG_PATH_USER_REGISTRATION_PENDING =
            WebApp.PATH_IMAGES_FAMFAM + "/user_gray.png";

    /**
     * Image path for expired user registrations.
     */
    public static final String IMG_PATH_USER_REGISTRATION_EXPIRED =
            WebApp.PATH_IMAGES_FAMFAM + "/user_red.png";
    /**
    ...
    /** */
    public static final String IMG_PATH_GENERIC_CHECKMARK_GREEN =
            WebApp.PATH_IMAGES_FAMFAM + "/tick.png";

    /** */
    public static final String IMG_PATH_GENERIC_CROSS_RED =
            WebApp.PATH_IMAGES_FAMFAM + "/cross.png";
    /** */
    public static final String IMG_PATH_GENERIC_ERROR =
            WebApp.PATH_IMAGES_FAMFAM + "/error.png";

    /** Hard Disk Drive. */
    public static final String IMG_PATH_GENERIC_HDD =
            WebApp.PATH_IMAGES_FAMFAM + "/drive.png";

    /** */
    public static final String IMG_PATH_GENERIC_TIME =
            WebApp.PATH_IMAGES_FAMFAM + "/time.png";
    /** */
    public static final String IMG_PATH_GENERIC_TIME_DELETE =
            WebApp.PATH_IMAGES_FAMFAM + "/time_delete.png";
