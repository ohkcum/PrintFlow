...
public final class ReqQueueGet extends ApiRequestMixin {
    ...
    public static class DtoRsp extends AbstractDto {
        ...
        private Boolean basicAuthApplicable;
        ...
        public Boolean getBasicAuthApplicable() {
            return basicAuthApplicable;
        }

        public void setBasicAuthApplicable(Boolean basicAuthApplicable) {
            this.basicAuthApplicable = basicAuthApplicable;
        }
    ...
    private void fillResponse(final IppQueue queue, final DtoRsp dtoRsp) {
        ...
        //
        dtoRsp.setBasicAuth(!queue.getTrusted() && QUEUE_SERVICE
                .getIppAuthMethod(queue) == IppAuthMethodEnum.BASIC);

        dtoRsp.setBasicAuthApplicable(reservedQueue == null
    ...
    private void fillResponseNew(final DtoRsp dtoRsp) {
        ...
        dtoRsp.setBasicAuth(Boolean.FALSE);
        dtoRsp.setBasicAuthApplicable(Boolean.TRUE);

        dtoRsp.setIppRouting(IppRoutingEnum.NONE);
