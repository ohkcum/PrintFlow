...
public final class ClientAppHandler
        implements IXmlRpcHandler, IRateLimiterListener, ServiceEntryPoint {
     ...
     * </p>
     */
    public static final String API_CLIENT_ID = "PrintFlowLite-client";
    ...
    /** */
    private static final String SHORT_NAME = "Client App";
    ...
    private static String getCometdUrlPath()
        ...
        return new URL(InetUtils.URL_PROTOCOL_HTTPS, "dummy", SSL_PORT,
                WebApp.MOUNT_PATH_COMETD).getPath();
    }
    ...
    private static URL getUserWebAppURLTemplate(final String userId)
        ...
        builder.setScheme(InetUtils.URL_PROTOCOL_HTTP).setHost("dummy")
                .setPort(SSL_PORT).setPath(WebApp.MOUNT_PATH_WEBAPP_USER)
                .addParameter(WebAppParmEnum.PFL_USER.parm(), userId);
    ...
    public String getConnectInfo(final String apiKey, final String userId,
        ...
        try {
            ...
            dto.setStatus(ClientAppConnectDto.Status.ERROR_FATAL);
            dto.setStatusMessage(String.format("Server error: %s", Objects
                    .toString(e.getMessage(), e.getClass().getSimpleName())));
        }
    ...
    private void publishLoginFailure(final String userId,
            final String clientIpAddress) throws EndlessWaitException {
    ...
    private void onRateLimiting(final String clientIPAddress)
        ...
        if (ConfigManager.isUserAuthRateLimitingEnabled()) {
            RATE_LIMITER_SERVICE.consumeOrWaitForEvent(
                    LimitEnum.USER_AUTH_FAILURE_BY_IP,
                    new RateLimiterService.IPEvent(clientIPAddress,
                            SHORT_NAME.concat(" Login")),
                    this);
        }
    }
