 ...
 */
package org.printflow.lite.ext.smtp;

import java.io.IOException;
import java.util.Properties;

import org.printflow.lite.ext.Office365Util;
import org.printflow.lite.ext.ServerPluginContext;
import org.printflow.lite.ext.ServerPluginException;

/**
 * Office365 SMTP authentication Plug-in.
 * <p>
 ...
 *
 */
public final class Office365OAuthSmtpPlugin extends OAuthSmtpPlugin {
     ...
     */
    private static final String PROP_KEY_PFX_IMAP = PROP_KEY_PFX + "smtp.";
    ...
    */
    ...
    public String retrieveToken() throws IOException {
        return Office365Util.retrieveOAuthTokenSmtp(this.tenantId,
