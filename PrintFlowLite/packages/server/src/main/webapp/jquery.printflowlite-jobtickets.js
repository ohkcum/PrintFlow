...
/*! PrintFlowLite jQuery Mobile Job Tickets Web App | (c) 2011-2020 Datraverse
...
(function($, window, document, JSON, _ns) {
    ...
    _ns.Controller = function(_i18n, _model, _view, _api) {
        ...
        this.init = function() {
            ...
            _view.pages.login.setAuthMode(res.authName, res.authEmail, res.authId,
                res.authYubiKey, res.authCardLocal, res.authCardIp,
                res.authModeDefault, res.authCardPinReq, null, res.yubikeyMaxMsecs,
     ...
     *
     */
    $.PrintFlowLiteApp = function(name) {
    ...
    $(function() {
        $.PrintFlowLiteApp = new $.PrintFlowLiteApp();
