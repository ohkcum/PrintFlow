...
/*! PrintFlowLite Common | (c) 2020 Datraverse B.V. | GNU Affero General Public License */
...
// Namespace
this.org = this.org || {};
this.org.printflow = this.org.printflow || {};
this.org.printflow.lite = {};
...
(function (window, document, navigator, _ns) {
  ...
  _ns.onLoadException = function () {
    ...
    document.write(
      "<html><body><p>Page cannot be loaded: check your browser settings.</p></body></html>",
    );
    document.close();
  };
  ...
  _ns.Utils.formatDateTime = function (date) {
    return (
      date.getFullYear() +
      "-" +
      _ns.Utils.zeroPad(date.getMonth() + 1, 2) +
      "-" +
      _ns.Utils.zeroPad(date.getDate(), 2) +
      " " +
      _ns.Utils.zeroPad(date.getHours(), 2) +
      ":" +
      _ns.Utils.zeroPad(date.getMinutes(), 2) +
      ":" +
      _ns.Utils.zeroPad(date.getSeconds(), 2)
    );
  };
      ...
      if (window.console) {
        ...
        if (_ns.Utils.isFunction(logger)) {
          ...
          [].splice.call(
            ...
            0,
            0,
            _ns.Utils.zeroPad(now.getHours(), 2) +
              ":" +
              _ns.Utils.zeroPad(now.getMinutes(), 2) +
              ":" +
              _ns.Utils.zeroPad(now.getSeconds(), 2) +
              "." +
              _ns.Utils.zeroPad(now.getMilliseconds(), 3),
          );
