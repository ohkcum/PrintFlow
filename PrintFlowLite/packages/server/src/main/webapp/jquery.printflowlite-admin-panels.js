...
/*! PrintFlowLite jQuery Mobile Admin Panels | (c) 2020 Datraverse B.V. | GNU
...
/*
 * PrintFlowLite jQuery Mobile Admin Panels
 */
(function($, window, document, JSON, _ns) {
    ...
    _ns.PanelAppLogBase = {
        ...
        input: {
            ...
            select: {
                ...
                // See Java:
                // org.printflow.lite.core.domain.AppLog.Level
                level: null,
                date_from: null,
                date_to: null,
                text: null
    ...
    _ns.PanelOptions = {
        ...
        onAuthMethodSelect: function(method) {
            ...
            _view.visible($('.auth-method-none-parms'), isNoneMethod);

            if (method === 'none' && !_view.getSelPresent($('.auth-method-none-parms'))) {
        ...
        onInternalUsersRegistrationEnabled: function(enabled) {
            var _view = _ns.PanelCommon.view;
            _view.visible($('#internal-users-registration-parms'), enabled);
        },
        ...
        onOutput: function(output) {
            ...
            this.onInternalUsersRegistrationEnabled(_view.isCbChecked($('#internal-users\\.registration\\.enable')));
    ...
    _ns.PanelUsersBase = {
        ...
        m2v: function() {
            ...
            val = this.input.select.registration;
            _view.checkRadioValue('sp-user-select-registration', !val || val === null ? "" : (val ? "1" : "0"));
        ...
        v2m: function() {
            ...
            val = _view.getRadioValue('sp-user-select-registration');
            this.input.select.registration = (!val || val === "" ? null : (val === "1"));
    ...
    _ns.PanelAccountsBase = {
        ...
        applyDefaults: function() {
            ...
            this.input.select.deleted = false;
            // Boolean
            this.input.select.registration = undefined;
            // Boolean
            this.input.sort.ascending = true;
        },
