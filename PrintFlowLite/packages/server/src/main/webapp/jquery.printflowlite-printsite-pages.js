...
/*! PrintFlowLite jQuery Mobile Print Site Web App | (c) 2020 Datraverse B.V.
    ...
    _ns.PageMain = function(_i18n, _view, _model, _api) {
        ...
        $(_self.id()).on('pagebeforeshow', function(event, ui) {
            ...
            $(this).on('click', '#sp-btn-user-pending-jobs', null, function() {
                ...
                _api.download("pdf-outbox", null, $(this).attr('data-PrintFlowLite'), _userKey);
                ...
                _onOutboxDeleteJob($(this).attr('data-PrintFlowLite'), false);
            }).on('click', '.sp-outbox-cancel-jobticket', null, function() {
                _onOutboxDeleteJob($(this).attr('data-PrintFlowLite'), true);
             ...
             * Register Panel
             */
            $(this).on('click', '#sp-btn-user-register', null, function() {
