...
/*! PrintFlowLite jQuery Mobile Print Delegation Page | (c) 2020 Datraverse B.V.
...
(function($, window, document, JSON, _ns) {
    ...
    _ns.PagePrintDelegation = function(_i18n, _view, _model, _api) {
        ...
        var _util = _ns.Utils,
            ...
            _CLASS_GROUP = '_PFL_group',
            _CLASS_USER = '_PFL_user',
            _CLASS_COPIES = '_PFL_copies',

            _CLASS_SELECTED_IND = '_PFL_selected',
            _CLASS_SELECTED_TXT = '_PFL_selected_txt',
            _CLASS_PREFERRED_IMG = '_PFL_preferred_img',
            ...
            _showQuickSearchGroupsAdded = function() {
                $.each($('#sp-print-delegation-groups-select-to-add-filter li'), function() {
                    var addedAsDelegator = _delegatorGroups[$(this).attr('data-PrintFlowLite')];
                    if (addedAsDelegator) {
            ...
            _onQuickSearchGroup = function(target, filter, startPosition, paging, rescope) {
                ...
                if (res.result.code === '0') {
                    ...
                    $.each(res.dto.items, function(key, item) {
                        ...
                        html += "<li class=\"ui-mini ui-li-has-icon\" data-icon=\"false\" data-PrintFlowLite=\"" + item.key + "\">";
                        html += "<a href=\"#\">";
                        html += "<span class=\"" + _CLASS_SELECTED_TXT + "\">" + _IND_SELECTED_OFF + "</span>&nbsp;";
                        html += _htmlGroupName(item) + "<span class=\"ui-li-count\">";
                        if (preferredEnabled) {
                            html += "<span class=\"" + _CLASS_PREFERRED_IMG + "\" data-PrintFlowLite=\"";
            ...
            _showQuickSearchUsersAdded = function() {
                $.each($('#sp-print-delegation-users-select-to-add-filter li'), function() {
                    var addedAsDelegator = _delegatorUsers[$(this).attr('data-PrintFlowLite')];
                    if (addedAsDelegator) {
                        _setUiStateDisabled($(this));
                    } else {
                        _removeUiStateDisabled($(this));
            ...
            _onQuickSearchUser = function(target, groupId, filter, startPosition, paging) {
                ...
                if (res.result.code === '0') {
                    ...
                    $.each(res.dto.items, function(key, item) {
                        ...
                        html += "\" data-icon=\"false\" data-PrintFlowLite=\"" + item.key;
                        html += "\">";
                        html += "<a href=\"#\">";
                        html += "<span class=\"" + _CLASS_SELECTED_TXT + "\">" + _IND_SELECTED_OFF + "</span>&nbsp;";
            ...
            _updateDelegatorRow = function(tbody, item, cssClass) {
                var row = tbody.find('[data-PrintFlowLite=' + item.id + ']');
            ...
            _appendDelegatorRow = function(tbody, item, account, cssClass, nCopies) {
                ...
                html = '<tr class="';
                html += cssClass;
                html += '" data-PrintFlowLite="' + item.key + '">';
                html += '<th>';
                html += "<span class=\"" + _CLASS_SELECTED_TXT + "\">" + _IND_SELECTED_OFF + "</span>&nbsp;";
            ...
            _onObjectPreferred = function(selection, request) {
                var span = selection.find('.' + _CLASS_PREFERRED_IMG),
                    dbKey = span.closest('li').attr('data-PrintFlowLite'),
                    preferredNew = span.attr('data-PrintFlowLite') !== _DATA_PREFERRED_ON,
                    res;

                span.html(preferredNew ? _IND_PREFERRED_ON : _IND_PREFERRED_OFF);
                span.attr('data-PrintFlowLite', preferredNew ? _DATA_PREFERRED_ON : _DATA_PREFERRED_OFF);
                ...
                if (res.result.code !== '0') {
                    ...
                    span.attr('data-PrintFlowLite', preferredNew ? _DATA_PREFERRED_OFF : _DATA_PREFERRED_ON);
                }
            }
            //----------------------------------------------------------------
            ,
            ...
            _onGroupSelected = function(selection) {
                ...
                dbkey = selection.attr('data-PrintFlowLite');
            ...
            _onDelegatorRemoveSelected = function() {
                ...
                $.each($('.' + _CLASS_SELECTED_TXT).closest('tr'), function() {
                    var dbkey = $(this).attr('data-PrintFlowLite');
        ...
        $('#page-print-delegation').on('pagecreate', function(event) {
            ...
            $("#sp-print-delegation-quicksearch-groups .sp-quicksearch-buttons .ui-btn").click(function() {
                _onQuickSearchGroup($("#sp-print-delegation-groups-select-to-add-filter"), $('#sp-print-delegation-groups-select-to-add').val(), $(this).attr('data-PrintFlowLite'), true);
            });
            ...
            $("#sp-print-delegation-quicksearch-users .sp-quicksearch-buttons .ui-btn").click(function() {
                var dbkey = _util.getFirstProp(_quickUserGroupSelected),
                    nextPosition = $(this).attr('data-PrintFlowLite');
            ...
            $("#sp-print-delegation-quicksearch-accounts .sp-quicksearch-buttons .ui-btn").click(function() {
                _onQuickSearchAccount($("#sp-print-delegation-select-shared-account-filter"), $('#sp-print-delegation-select-shared-account').val(), $(this).attr('data-PrintFlowLite'), true);
            });
